...
r1,p1,r2,p2=map(float,sys.stdin.read().split()); a=r1*r2*math.cos(p1+p2); b=r1*r2*math.sin(p1+p2)
print(f'{0 if abs(a)<.005 else a:.2f}{"+" if b>=.005 else "-"}{abs(0 if abs(b)<.005 else b):.2f}i')
